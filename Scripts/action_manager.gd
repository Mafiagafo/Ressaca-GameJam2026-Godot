...
func _init() -> void:
	master_actions = [
		...
		ActionButton.new("reduce", "Reduce Speed", {"fuel_level": 0.5, "passenger_comfort": 1.0, "punctual_arrival": - 2.0, "company_trust": - 1.0}),
		...
		ActionButton.new("stabilize", "Stabilize Struct.", {"structural_hp": 2.0, "punctual_arrival": - 2.0, "company_trust": - 2.0}),
